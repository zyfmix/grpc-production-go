...
func (c *greeterClient) SayList(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Greeter_SayListClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], "/helloworld.Greeter/SayList", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) SayRecord(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayRecordClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[1], "/helloworld.Greeter/SayRecord", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) SayRoute(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayRouteClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[2], "/helloworld.Greeter/SayRoute", opts...)
	if err != nil {
		return nil, err
	}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "src/rpc/helloworld/proto/helloworld.proto",
}
